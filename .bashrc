...
#Neat CLI utilities for meatspace
alias ipaddr='curl ipaddr.io/ -4' 
alias weather='curl wttr.in/78249'

# YourClassical.org streams
alias choral='mplayer http://50.31.167.234'
alias classical-radio='mplayer http://50.31.167.247'

# OS X Specific lines.  Leave active at your own risk on GNU/Linux
export CLICOLOR=1
export LSCOLORS=gxBxhxDxfxhxhxhxhxcxcx
source ~/.iterm2_shell_integration.`basename $SHELL`
alias battery-life='pmset -g batt'
